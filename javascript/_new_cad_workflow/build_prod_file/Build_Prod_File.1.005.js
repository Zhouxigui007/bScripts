/* 	
	...
	Version History:
		...
		Version 1.005: 11.4.15
			It looks unlikely that the web team will save the roster information to the network for our usage.
			Experimenting now with shell scripts. Applescript is out due to cross platform compatibility issues.
			Going to try to use Python as shell script. Need to check cross platform compatibility. This version
			will likely be garbage. Will probably need to revert to 1.004 for additional changes.
